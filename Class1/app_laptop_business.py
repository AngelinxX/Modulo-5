...
class App:
    def __init__(self, root) :
        self.root = root
        self.laptops = []
        self.imagenes = ["E:\\Krakedev\Modulo 5\\Modulo-5\\Class1\\img\\images.jpeg","E:\\Krakedev\\Modulo 5\\Modulo-5\\Class1\\img\\images (1).jpeg","E:\\Krakedev\\Modulo 5\\Modulo-5\\Class1\\img\\images (2).jpeg","E:\\Krakedev\\Modulo 5\\Modulo-5\\Class1\\img\\images (3).jpeg","E:\\Krakedev\\Modulo 5\\Modulo-5\\Class1\\img\\images (4).jpeg"]

        root.title("Ingresar Datos Bussiness")
    ...
    def setup_ui(self):
        ...
        ttk.Label(self.root, text="Espacio de disco").grid(row=3,column=0)
        self.espacio_de_disco=tk.StringVar()
        ttk.Entry(self.root, textvariable=self.espacio_de_disco).grid(row=3,column=1)
        ...
        self.mostrar_laptops.grid(row=7,column=1, columnspan=2)

        self.canva = tk.Canvas(self.root, width=200, height=200)
        self.canva.grid(row=1, column=3, rowspan=6)

    def agregar_laptop(self):
        nueva_laptop = Laptop_business(self.marca.get(), self.procesador.get(), self.memoria.get(), self.espacio_de_disco.get(), self.duracion_bateria.get(),self.precio.get())
